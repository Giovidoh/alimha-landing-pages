...
const LocalSwitcherSelect = () => {
    ...
    const selectedLanguage = (
        <div className="flex justify-between items-center bg-white w-full px-3 py-2 gap-2 border-[2px] border-primary-blue rounded-md shadow-lg">
            <Image
