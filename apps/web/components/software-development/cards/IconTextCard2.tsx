...
const IconTextCard: FC<IconTextCardProps> = ({ icon, title, body }) => {
    return (
        <div
            className={`flex items-start bg-white w-full h-fit p-5 gap-4 rounded-2xl shadow-lg`}
        >
            ...
            <div>
                ...
                <div className="flex justify-between items-center">
                    <p className="font-light text-sm lg:text-base text-pretty tracking-wide text-gray-1">
                        {body}
                    </p>
                </div>
            </div>
